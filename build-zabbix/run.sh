...
sed -i 's/# DBPassword=/'DBPassword=$ZB_MYSQL_PASS'/g'                  /etc/zabbix/zabbix_server.conf
sed -i 's/# DBHost=localhost/'DBHost=$ZB_MYSQL_HOST'/g'                 /etc/zabbix/zabbix_server.conf
